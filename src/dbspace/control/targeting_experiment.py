...
BASE_LFP_DIR = "/home/virati/Data/phd_vrt_2013/neural/lfp/"


# %%
# Below should be EXPERIMENT-SPECIFIC STRUCTURE and put into a yaml or something for Mayberg work
TARGETING_LFP = defaultdict(dict)
TARGETING_LFP["All"] = {
    "901": {
        "OnT": {
...
TARGETING_EEG = defaultdict(dict)
# TargetingEXP['conservative'] = {'905':0,'906':0,'907':0,'908':0}
TARGETING_EEG["conservative"] = {
    "905": {
        "OnT": BASE_EEG_DIR
